...
const FAQ = () => {
  return (
    <section className="faq-container xl:max-w-[1200px] sm:max-w-[300px]  mx-auto mb-[160px]">
      ...
      <div className="list-faq">
        <div className="faq-answer-item xl:pb-[40px] xl:border-b xl:border-b-[#FFFFFF1A]">
          <div className="flex justify-between mb-[32px]">
            <p className="text-primary font-primary xl:text-[24px] xl:leading-[1.3] sm:text-[12px]">
        ...
        <div className="faq-question-item flex justify-between xl:pt-[44px] xl:border-b xl:border-b-[#FFFFFF1A] xl:pb-[40px] sm:pt-[20px] sm:pb-[20px]">
          <p className="text-primary font-primary xl:text-[24px] xl:leading-[1.4] sm:text-[12px] sm:max-w-[80%]">
        ...
        <div className="button-create-investment  xl:max-w-[200px] mx-auto sm:max-w-[100px] mt-[50px]">
          <button className=" xl:py-[10px]  xl:px-[19px] bg-primary text-primary text-center xl:text-[18px] font-primary rounded-[5px] sm:text-[12px] sm:py-[6px] sm:px-[16px] w-full">
            See more
          </button>
        </div>
      </div>
