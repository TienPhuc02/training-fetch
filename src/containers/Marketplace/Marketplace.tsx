  ...
  return (
    <section className="create-investment-container  mt-[256px] px-[68px] mb-[140px]">
      <div className="header-create-investment max-w-[1064px] mb-[68px]">
        <p className="title-create-investment text-center font-secondary text-[40px] max-w-[532px] mx-auto text-primary">
          Marketplace for squad assets
        </p>
        <p className="description-create-investment font-primary text-[20px] text-center text-secondary">
