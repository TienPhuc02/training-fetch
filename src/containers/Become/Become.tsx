...
const Become = () => {
  return (
    ...
    >
      <div className="become-left text-primary xl:max-w-[441px] xl:max-h-[354px] xl:items-start flex sm:flex-col sm:items-center">
        ...
        <p className="xl:font-primary xl:text-[20px] xl:text-secondary xl:mb-[50px] xl:text-left leading-[1.2] sm:text-[14px] lg:text-secondary sm:mb-[30px] sm:text-center">
      ...
      <div className="become-right lg:flex lg:gap-[20px] text-primary lg:flex-col lg:items-center lg:justify-center">
        <div className="xl:w-[660px] lg:w-[500px]">
          <Image
